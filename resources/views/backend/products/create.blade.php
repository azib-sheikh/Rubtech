...
<div class="container-fluid py-3">
    ...
    <div class="p-3 bg-white mt-4">
        <form method="POST" action="{{ route('blogs.store') }}">
            ...
            <div class="mb-3">
                <label for="image" class="form-label">Product's Images</label>
            ...
            <div class="mb-3">
                <label for="postcontent" class="form-label">Product's Content</label>
                <textarea class="form-control w-100" name="content" id="" rows="10"></textarea>
            </div>
            <div class="mb-3">
                <label for="postcontent" class="form-label">Product's Description</label>
                <textarea class="form-control w-100" name="content" id="" rows="10"></textarea>
            </div>
            <div class="mb-3">
                <label for="postcontent" class="form-label">Product's Comparison</label>
                <textarea class="form-control w-100" name="content" id="" rows="10"></textarea>
            </div>
            <div class="mt-4">
